...
### Added
- Support repo-local config (#360)

### Fixed
- Skip reparenting doomed merged branches (#425)

## [0.79.0] - 2026-05-21

### Added
- Add submit.single_stack option (#421)

## [0.78.2] - 2026-05-21

### Fixed
- Sync PR state and base from GitHub during sync (#420)

## [0.78.1] - 2026-05-20

### Changed
- Fix stack link context per PR (#422)

## [0.78.0] - 2026-05-20

### Fixed
- Avoid duplicate fetch during update (#419)

### Documentation
- Remove stale just target references (#418)

## [0.77.0] - 2026-05-19

### Changed
- Guard create --below collisions and scoped stack links (#413)
- Removed unnessessary files

### Fixed
- Skip merged cleanup during update (#415)
...
[0.78.1]: https://github.com/cesarferreira/stax/compare/v0.78.0...v0.78.1
[0.78.0]: https://github.com/cesarferreira/stax/compare/v0.77.0...v0.78.0
[0.77.0]: https://github.com/cesarferreira/stax/compare/v0.76.0...v0.77.0
